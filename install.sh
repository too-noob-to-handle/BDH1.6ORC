...
sudo apt-get -qq install -y --no-install-recommends curl git gnupg2 unzip wget pv jq aria2 7zip
...
sudo chmod +x /content/accounts/DRMv1.7.AUM.Linux/utils/N_m3u8DL-RE
...
sudo chmod +x /content/accounts/DRMv1.7.AUM.Linux/mp4decrypt/mp4decrypt_linux
sudo chmod +x /content/accounts/DRMv1.7.AUM.Linux/mp4decrypt/mp4decrypt_mac
